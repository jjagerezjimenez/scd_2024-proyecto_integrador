...
class receptor_QAM_4(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "RECEPTOR", catch_exceptions=True)
        ...
        self.settings = Qt.QSettings("GNU Radio", "receptor_QAM_4")
        ...
        self.QAM_4 = QAM_4 = digital.constellation_rect([0.707+0.707j, -0.707+0.707j, -0.707-0.707j, 0.707-0.707j], [0, 1, 2, 3],
        4, 2, 2, 1, 1).base()
    ...
    def set_QAM_4(self, QAM_4):
        self.QAM_4 = QAM_4




def main(top_block_cls=receptor_QAM_4, options=None):
