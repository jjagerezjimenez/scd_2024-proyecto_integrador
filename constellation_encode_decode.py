...
class constellation_encode_decode(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Constellation Encoder and Decoder", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Constellation Encoder and Decoder")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "constellation_encode_decode")
        ...
        self.mod_order = mod_order = len(constel.points())
        self.data_size = data_size = 1000
        self.samp_rate = samp_rate = 32000
        self.data = data = [random.randrange(mod_order) for i in range(data_size)]
        ...
        self.digital_constellation_encoder_bc_0 = digital.constellation_encoder_bc(constel)
    ...
    def set_constel(self, constel):
        ...
        self.digital_constellation_encoder_bc_0.set_constellation(self.constel)
    ...
    def set_mod_order(self, mod_order):
        ...
        self.set_data([random.randrange(self.mod_order) for i in range(self.data_size)])
...
def main(top_block_cls=constellation_encode_decode, options=None):
