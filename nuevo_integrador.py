...
class nuevo_integrador(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "nuevo_integrador")
...
def main(top_block_cls=nuevo_integrador, options=None):
