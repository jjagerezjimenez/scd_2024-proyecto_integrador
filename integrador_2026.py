...
class integrador_2026(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._noise_var_range = qtgui.Range(0, 1, 0.05, 0, 200)
        ...
        self.digital_packet_headerparser_b_default_0 = digital.packet_headerparser_b(32, "packet_len")
        ...
        self.blocks_tag_debug_1 = blocks.tag_debug(gr.sizeof_char*1, "salida demux", "")
        self.blocks_tag_debug_1.set_display(True)
        self.blocks_repack_bits_bb_2 = blocks.repack_bits_bb(1, 8, "frame_start", True, gr.GR_MSB_FIRST)
        ...
        self.msg_connect((self.digital_packet_headerparser_b_default_0, 'header_data'), (self.blocks_message_debug_1, 'print'))
        ...
        self.connect((self.blocks_repack_bits_bb_2, 0), (self.digital_header_payload_demux_0, 0))
        ...
        self.connect((self.digital_header_payload_demux_0, 1), (self.blocks_tag_debug_1, 0))
